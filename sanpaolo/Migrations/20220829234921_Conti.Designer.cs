...
namespace sanpaolo.Migrations
{
    ...
    [Migration("20220829234921_Conti")]
    partial class Conti
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("sanpaolo.Models.Transazione", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("sanpaolo.Models.Salvadanaio", b =>
                {
                    b.HasOne("sanpaolo.Models.Conto", "Conto")
                        .WithOne("Salvadanaio")
                        .HasForeignKey("sanpaolo.Models.Salvadanaio", "ContoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
